...
set(CONAN_DOCOPT_ROOT "/home/therealtyler/.conan/data/docopt/0.6.2/conan/stable/package/2d5685a99e2ff5a0d2b054bb1fbfa46781f8a46a")
set(CONAN_INCLUDE_DIRS_DOCOPT "/home/therealtyler/.conan/data/docopt/0.6.2/conan/stable/package/2d5685a99e2ff5a0d2b054bb1fbfa46781f8a46a/include")
set(CONAN_LIB_DIRS_DOCOPT "/home/therealtyler/.conan/data/docopt/0.6.2/conan/stable/package/2d5685a99e2ff5a0d2b054bb1fbfa46781f8a46a/lib")
set(CONAN_BIN_DIRS_DOCOPT )
set(CONAN_RES_DIRS_DOCOPT )
set(CONAN_BUILD_DIRS_DOCOPT "/home/therealtyler/.conan/data/docopt/0.6.2/conan/stable/package/2d5685a99e2ff5a0d2b054bb1fbfa46781f8a46a/")
set(CONAN_LIBS_DOCOPT docopt)
set(CONAN_DEFINES_DOCOPT )
# COMPILE_DEFINITIONS are equal to CONAN_DEFINES without -D, for targets
set(CONAN_COMPILE_DEFINITIONS_DOCOPT )

set(CONAN_C_FLAGS_DOCOPT "")
set(CONAN_CXX_FLAGS_DOCOPT "")
set(CONAN_SHARED_LINKER_FLAGS_DOCOPT "")
set(CONAN_EXE_LINKER_FLAGS_DOCOPT "")

# For modern cmake targets we use the list variables (separated with ;)
set(CONAN_C_FLAGS_DOCOPT_LIST "")
set(CONAN_CXX_FLAGS_DOCOPT_LIST "")
set(CONAN_SHARED_LINKER_FLAGS_DOCOPT_LIST "")
set(CONAN_EXE_LINKER_FLAGS_DOCOPT_LIST "")


set(CONAN_JSONFORMODERNCPP_ROOT "/home/therealtyler/.conan/data/jsonformoderncpp/2.1.1/vthiery/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9")
set(CONAN_INCLUDE_DIRS_JSONFORMODERNCPP "/home/therealtyler/.conan/data/jsonformoderncpp/2.1.1/vthiery/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include")
set(CONAN_LIB_DIRS_JSONFORMODERNCPP )
set(CONAN_BIN_DIRS_JSONFORMODERNCPP )
set(CONAN_RES_DIRS_JSONFORMODERNCPP )
set(CONAN_BUILD_DIRS_JSONFORMODERNCPP "/home/therealtyler/.conan/data/jsonformoderncpp/2.1.1/vthiery/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/")
...
set(CONAN_DEPENDENCIES docopt jsonformoderncpp)
...
set(CONAN_INCLUDE_DIRS "/home/therealtyler/.conan/data/docopt/0.6.2/conan/stable/package/2d5685a99e2ff5a0d2b054bb1fbfa46781f8a46a/include"
			"/home/therealtyler/.conan/data/jsonformoderncpp/2.1.1/vthiery/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include" ${CONAN_INCLUDE_DIRS})
set(CONAN_LIB_DIRS "/home/therealtyler/.conan/data/docopt/0.6.2/conan/stable/package/2d5685a99e2ff5a0d2b054bb1fbfa46781f8a46a/lib" ${CONAN_LIB_DIRS})
set(CONAN_BIN_DIRS  ${CONAN_BIN_DIRS})
set(CONAN_RES_DIRS  ${CONAN_RES_DIRS})
set(CONAN_LIBS docopt ${CONAN_LIBS})
set(CONAN_DEFINES  ${CONAN_DEFINES})
set(CONAN_CMAKE_MODULE_PATH "/home/therealtyler/.conan/data/docopt/0.6.2/conan/stable/package/2d5685a99e2ff5a0d2b054bb1fbfa46781f8a46a/"
			"/home/therealtyler/.conan/data/jsonformoderncpp/2.1.1/vthiery/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/" ${CONAN_CMAKE_MODULE_PATH})
...
macro(conan_define_targets)
    ...
    conan_package_library_targets("${CONAN_LIBS_DOCOPT}" "${CONAN_LIB_DIRS_DOCOPT}"
                                  CONAN_PACKAGE_TARGETS_DOCOPT "" "" docopt)
    conan_package_library_targets("${CONAN_LIBS_DOCOPT_DEBUG}" "${CONAN_LIB_DIRS_DOCOPT_DEBUG}"
                                  CONAN_PACKAGE_TARGETS_DOCOPT_DEBUG "" "debug" docopt)
    conan_package_library_targets("${CONAN_LIBS_DOCOPT_RELEASE}" "${CONAN_LIB_DIRS_DOCOPT_RELEASE}"
                                  CONAN_PACKAGE_TARGETS_DOCOPT_RELEASE "" "release" docopt)

    add_library(CONAN_PKG::docopt INTERFACE IMPORTED)

    # Property INTERFACE_LINK_FLAGS do not work, necessary to add to INTERFACE_LINK_LIBRARIES
    set_property(TARGET CONAN_PKG::docopt PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_DOCOPT} ${CONAN_SHARED_LINKER_FLAGS_DOCOPT_LIST} ${CONAN_EXE_LINKER_FLAGS_DOCOPT_LIST}
                                                                 $<$<CONFIG:Release>:${CONAN_PACKAGE_TARGETS_DOCOPT_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_DOCOPT_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_DOCOPT_RELEASE_LIST}>
                                                                 $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_DOCOPT_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_DOCOPT_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_DOCOPT_RELEASE_LIST}>
                                                                 $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_DOCOPT_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_DOCOPT_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_DOCOPT_RELEASE_LIST}>
                                                                 $<$<CONFIG:Debug>:${CONAN_PACKAGE_TARGETS_DOCOPT_DEBUG} ${CONAN_SHARED_LINKER_FLAGS_DOCOPT_DEBUG_LIST} ${CONAN_EXE_LINKER_FLAGS_DOCOPT_DEBUG_LIST}>
                                                                 )
    set_property(TARGET CONAN_PKG::docopt PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${CONAN_INCLUDE_DIRS_DOCOPT}
                                                                      $<$<CONFIG:Release>:${CONAN_INCLUDE_DIRS_DOCOPT_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_INCLUDE_DIRS_DOCOPT_RELEASE}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_INCLUDE_DIRS_DOCOPT_RELEASE}>
                                                                      $<$<CONFIG:Debug>:${CONAN_INCLUDE_DIRS_DOCOPT_DEBUG}>)
    set_property(TARGET CONAN_PKG::docopt PROPERTY INTERFACE_COMPILE_DEFINITIONS ${CONAN_COMPILE_DEFINITIONS_DOCOPT}
                                                                      $<$<CONFIG:Release>:${CONAN_COMPILE_DEFINITIONS_DOCOPT_RELEASE}>
                                                                      $<$<CONFIG:RelWithDebInfo>:${CONAN_COMPILE_DEFINITIONS_DOCOPT_RELEASE}>
                                                                      $<$<CONFIG:MinSizeRel>:${CONAN_COMPILE_DEFINITIONS_DOCOPT_RELEASE}>
                                                                      $<$<CONFIG:Debug>:${CONAN_COMPILE_DEFINITIONS_DOCOPT_DEBUG}>)
    set_property(TARGET CONAN_PKG::docopt PROPERTY INTERFACE_COMPILE_OPTIONS ${CONAN_C_FLAGS_DOCOPT_LIST} ${CONAN_CXX_FLAGS_DOCOPT_LIST}
                                                                  $<$<CONFIG:Release>:${CONAN_C_FLAGS_DOCOPT_RELEASE_LIST} ${CONAN_CXX_FLAGS_DOCOPT_RELEASE_LIST}>
                                                                  $<$<CONFIG:RelWithDebInfo>:${CONAN_C_FLAGS_DOCOPT_RELEASE_LIST} ${CONAN_CXX_FLAGS_DOCOPT_RELEASE_LIST}>
                                                                  $<$<CONFIG:MinSizeRel>:${CONAN_C_FLAGS_DOCOPT_RELEASE_LIST} ${CONAN_CXX_FLAGS_DOCOPT_RELEASE_LIST}>
                                                                  $<$<CONFIG:Debug>:${CONAN_C_FLAGS_DOCOPT_DEBUG_LIST}  ${CONAN_CXX_FLAGS_DOCOPT_DEBUG_LIST}>)
    ...
    set(CONAN_TARGETS CONAN_PKG::docopt CONAN_PKG::jsonformoderncpp)
